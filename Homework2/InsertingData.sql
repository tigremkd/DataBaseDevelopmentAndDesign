...
-- This will make sure that every record from the tables is deleted
-- before inserting new data into them
...
-- This is how temporary table is declared in SQL
-- and in same time how data is inserted into it
